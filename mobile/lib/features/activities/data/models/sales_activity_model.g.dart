...
_SalesActivityModel _$SalesActivityModelFromJson(Map<String, dynamic> json) =>
    _SalesActivityModel(
      ...
      activityAt: const DateTimeUtcConverter().fromJson(
        json['activity_at'] as String,
      ),
      createdAt: const DateTimeUtcNullableConverter().fromJson(
        json['created_at'] as String?,
      ),
      updatedAt: const DateTimeUtcNullableConverter().fromJson(
        json['updated_at'] as String?,
      ),
      latitude: (json['latitude'] as num?)?.toDouble(),
      longitude: (json['longitude'] as num?)?.toDouble(),
      checkInTime: const DateTimeUtcNullableConverter().fromJson(
        json['check_in_time'] as String?,
      ),
      checkOutTime: const DateTimeUtcNullableConverter().fromJson(
...
Map<String, dynamic> _$SalesActivityModelToJson(
  _SalesActivityModel instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'created_at': const DateTimeUtcNullableConverter().toJson(instance.createdAt),
  'updated_at': const DateTimeUtcNullableConverter().toJson(instance.updatedAt),
  'latitude': instance.latitude,
  'longitude': instance.longitude,
  'check_in_time': const DateTimeUtcNullableConverter().toJson(
    instance.checkInTime,
  ),
  'check_out_time': const DateTimeUtcNullableConverter().toJson(
