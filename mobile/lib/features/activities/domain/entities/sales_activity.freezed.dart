...
mixin _$SalesActivity {
  ...
  @override
  String toString() {
    return 'SalesActivity(id: $id, title: $title, userId: $userId, leadId: $leadId, customerId: $customerId, dealId: $dealId, activityType: $activityType, notes: $notes, activityAt: $activityAt, createdAt: $createdAt, updatedAt: $updatedAt, lead: $lead, customer: $customer, deal: $deal)';
  }
}
