            ...
            children: [
              ...
              Center(
                child: Padding(
                  ...
                  child: Text(
                    'This will create a new Customer and a Deal object in your pipeline.',
                ...
                child: BlocBuilder<LeadBloc, LeadState>(
                  builder: (context, state) {
                    return ElevatedButton(
                      onPressed: state is LeadLoading
                          ? null
                          : () => context.read<LeadBloc>().add(ConvertLeadSubmitted(lead.id)),
