...
mixin _$DealItem {
 ...
 String get id;@JsonKey(name: 'deal_id') String? get dealId;@JsonKey(name: 'product_id') String get productId; String get name; double get quantity; String get unit;@JsonKey(name: 'unit_price') double get unitPrice; double get discount; double get subtotal; String? get notes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,dealId,productId,name,quantity,unit,unitPrice,discount,subtotal,notes);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'deal_id') String? dealId,@JsonKey(name: 'product_id') String productId, String name, double quantity, String unit,@JsonKey(name: 'unit_price') double unitPrice, double discount, double subtotal, String? notes
});
...
/// Create a copy of DealItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? dealId = freezed,Object? productId = null,Object? name = null,Object? quantity = null,Object? unit = null,Object? unitPrice = null,Object? discount = null,Object? subtotal = null,Object? notes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'deal_id')  String? dealId, @JsonKey(name: 'product_id')  String productId,  String name,  double quantity,  String unit, @JsonKey(name: 'unit_price')  double unitPrice,  double discount,  double subtotal,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DealItem() when $default != null:
return $default(_that.id,_that.dealId,_that.productId,_that.name,_that.quantity,_that.unit,_that.unitPrice,_that.discount,_that.subtotal,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'deal_id')  String? dealId, @JsonKey(name: 'product_id')  String productId,  String name,  double quantity,  String unit, @JsonKey(name: 'unit_price')  double unitPrice,  double discount,  double subtotal,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _DealItem():
return $default(_that.id,_that.dealId,_that.productId,_that.name,_that.quantity,_that.unit,_that.unitPrice,_that.discount,_that.subtotal,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'deal_id')  String? dealId, @JsonKey(name: 'product_id')  String productId,  String name,  double quantity,  String unit, @JsonKey(name: 'unit_price')  double unitPrice,  double discount,  double subtotal,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _DealItem() when $default != null:
return $default(_that.id,_that.dealId,_that.productId,_that.name,_that.quantity,_that.unit,_that.unitPrice,_that.discount,_that.subtotal,_that.notes);case _:
  return null;
...
class _DealItem extends DealItem {
  const _DealItem({required this.id, @JsonKey(name: 'deal_id') this.dealId, @JsonKey(name: 'product_id') required this.productId, required this.name, required this.quantity, required this.unit, @JsonKey(name: 'unit_price') required this.unitPrice, required this.discount, required this.subtotal, this.notes}): super._();
...
/// Create a copy of DealItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? dealId = freezed,Object? productId = null,Object? name = null,Object? quantity = null,Object? unit = null,Object? unitPrice = null,Object? discount = null,Object? subtotal = null,Object? notes = freezed,}) {
