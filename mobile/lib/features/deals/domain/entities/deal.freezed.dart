...
mixin _$Deal {
 ...
 String get id; String get title;@JsonKey(name: 'customer_id') String? get customerId;@JsonKey(name: 'lead_id') String? get leadId;@JsonKey(name: 'contact_id') String? get contactId; String get stage; String get status; double? get amount; int? get probability;@JsonKey(name: 'expected_close') DateTime? get expectedClose; String? get description; List<DealItem>? get items; Customer? get customer;@JsonKey(name: 'sales_id') String? get salesId;@JsonKey(name: 'salesman_name') String? get salesmanName;
...
@useResult
$Res call({
 String id, String title,@JsonKey(name: 'customer_id') String? customerId,@JsonKey(name: 'lead_id') String? leadId,@JsonKey(name: 'contact_id') String? contactId, String stage, String status, double? amount, int? probability,@JsonKey(name: 'expected_close') DateTime? expectedClose, String? description, List<DealItem>? items, Customer? customer,@JsonKey(name: 'sales_id') String? salesId,@JsonKey(name: 'salesman_name') String? salesmanName
});
...
/// Create a copy of Deal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? customerId = freezed,Object? leadId = freezed,Object? contactId = freezed,Object? stage = null,Object? status = null,Object? amount = freezed,Object? probability = freezed,Object? expectedClose = freezed,Object? description = freezed,Object? items = freezed,Object? customer = freezed,Object? salesId = freezed,Object? salesmanName = freezed,}) {
...
as int?,expectedClose: freezed == expectedClose ? _self.expectedClose : expectedClose // ignore: cast_nullable_to_non_nullable
as DateTime?,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,items: freezed == items ? _self.items : items // ignore: cast_nullable_to_non_nullable
as List<DealItem>?,customer: freezed == customer ? _self.customer : customer // ignore: cast_nullable_to_non_nullable
as Customer?,salesId: freezed == salesId ? _self.salesId : salesId // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Deal() when $default != null:
return $default(_that.id,_that.title,_that.customerId,_that.leadId,_that.contactId,_that.stage,_that.status,_that.amount,_that.probability,_that.expectedClose,_that.description,_that.items,_that.customer,_that.salesId,_that.salesmanName);case _:
  return orElse();
...
class _Deal implements Deal {
  const _Deal({required this.id, required this.title, @JsonKey(name: 'customer_id') this.customerId, @JsonKey(name: 'lead_id') this.leadId, @JsonKey(name: 'contact_id') this.contactId, required this.stage, required this.status, this.amount, this.probability, @JsonKey(name: 'expected_close') this.expectedClose, this.description, final  List<DealItem>? items, this.customer, @JsonKey(name: 'sales_id') this.salesId, @JsonKey(name: 'salesman_name') this.salesmanName}): _items = items;
...
@override@JsonKey(name: 'expected_close') final  DateTime? expectedClose;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,customerId,leadId,contactId,stage,status,amount,probability,expectedClose,description,const DeepCollectionEquality().hash(_items),customer,salesId,salesmanName);
...
/// Create a copy of Deal
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? customerId = freezed,Object? leadId = freezed,Object? contactId = freezed,Object? stage = null,Object? status = null,Object? amount = freezed,Object? probability = freezed,Object? expectedClose = freezed,Object? description = freezed,Object? items = freezed,Object? customer = freezed,Object? salesId = freezed,Object? salesmanName = freezed,}) {
  return _then(_Deal(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,customerId: freezed == customerId ? _self.customerId : customerId // ignore: cast_nullable_to_non_nullable
