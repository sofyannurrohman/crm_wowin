...
mixin _$InventoryItem {
 ...
 String get id;@JsonKey(name: 'product_id') String get productId; double get quantity;@JsonKey(name: 'product_name') String? get productName;@JsonKey(name: 'product_sku') String? get productSku;@JsonKey(name: 'product_unit') String? get productUnit;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,productId,quantity,productName,productSku,productUnit,updatedAt);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'product_id') String productId, double quantity,@JsonKey(name: 'product_name') String? productName,@JsonKey(name: 'product_sku') String? productSku,@JsonKey(name: 'product_unit') String? productUnit,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of InventoryItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? productId = null,Object? quantity = null,Object? productName = freezed,Object? productSku = freezed,Object? productUnit = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'product_id')  String productId,  double quantity, @JsonKey(name: 'product_name')  String? productName, @JsonKey(name: 'product_sku')  String? productSku, @JsonKey(name: 'product_unit')  String? productUnit, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InventoryItem() when $default != null:
return $default(_that.id,_that.productId,_that.quantity,_that.productName,_that.productSku,_that.productUnit,_that.updatedAt);case _:
  return orElse();
...
class _InventoryItem implements InventoryItem {
  const _InventoryItem({required this.id, @JsonKey(name: 'product_id') required this.productId, required this.quantity, @JsonKey(name: 'product_name') this.productName, @JsonKey(name: 'product_sku') this.productSku, @JsonKey(name: 'product_unit') this.productUnit, @JsonKey(name: 'updated_at') this.updatedAt});
...
/// Create a copy of InventoryItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? productId = null,Object? quantity = null,Object? productName = freezed,Object? productSku = freezed,Object? productUnit = freezed,Object? updatedAt = freezed,}) {
